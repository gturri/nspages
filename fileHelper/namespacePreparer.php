...
class namespacePreparer extends filePreparer {
    function __construct($excludedFiles, $pregOn, $pregOff, $pregTitleOn, $pregTitleOff, $useTitle, $useAbstract, $sortPageById, $useIdAndTitle, $sortPageByDate, $sortByCreationDate){
        parent::__construct($excludedFiles, $pregOn, $pregOff, $pregTitleOn, $pregTitleOff, $useTitle, $useAbstract, $sortPageById, $useIdAndTitle, $sortPageByData, $sortByCreationDate);
    }
